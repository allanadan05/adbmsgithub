...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2019 at 03:15 PM
...
CREATE TABLE `lessontbl` (
  ...
  `lessonpdf` varchar(999) NOT NULL,
  `subjectid` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `lessontbl` (`lessonid`, `lessontitle`, `lessondetail`, `lessonpdf`, `subjectid`) VALUES
(1, '', '', '', 1),
(2, 'dota oh ako!', 'some quick example text to build on the card title and make up the bulk of cards content', '', 1),
(3, 'computer lord!', 'omaywa ashindederu!', '', 2),
(4, 'dota oh ako!', 'aasdasdasdasdasdasdasdasdasdasdasdasdasdasd', 'OOP_REVIEWER.pdf', 1),
(5, '', '', '', 0),
(6, 'asdasd', 'asdasdasd', 'OOP_REVIEWER.pdf', 1),
(7, 'asdasdasd', 'asdqweqwe xcvxvxcvxaaa', 'OOP_REVIEWER.pdf', 2),
(8, 'asdasdasd', 'dota oh ako!', 'OOP_REVIEWER.pdf', 2),
(9, 'asdasdasd', 'computer is life!', 'OOP_REVIEWER.pdf', 2),
(10, 'asdasd', 'asdasdad', 'OOP_REVIEWER.pdf', 3),
(11, 'asdads', 'asdasdasd', 'OOP_REVIEWER.pdf', 1),
(12, 'dota oh ako!', 'asdasasdsa', 'OOP_REVIEWER.pdf', 2),
(13, 'asdasdasd', 'asdasdasd', 'OOP_REVIEWER.pdf', 1),
(14, 'asdasdasd', 'asdasdasd', 'OOP_REVIEWER.pdf', 1),
(15, 'asdasdasd', 'dota oh bato!', 'OOP_REVIEWER.pdf', 2),
(16, 'asdasd', 'asdasd', 'OOP_REVIEWER.pdf', 3),
(17, 'asdasdas', 'asdasdasd', 'OOP_REVIEWER.pdf', 3);
...
--
-- Table structure for table `sectionlessonbridgetbl`
--

CREATE TABLE `sectionlessonbridgetbl` (
  `sectionlessonbridgeid` int(10) NOT NULL,
  `userid` int(10) DEFAULT NULL,
  `sectionid` int(10) DEFAULT NULL,
  `teacher` varchar(10) DEFAULT NULL,
  `student` varchar(10) DEFAULT NULL,
  `lessmid` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Truncate table before insert `sectionlessonbridgetbl`
--

TRUNCATE TABLE `sectionlessonbridgetbl`;
-- --------------------------------------------------------
...
--
-- Indexes for table `sectionlessonbridgetbl`
--
ALTER TABLE `sectionlessonbridgetbl`
  ADD PRIMARY KEY (`sectionlessonbridgeid`);
...
--
ALTER TABLE `lessontbl`
  MODIFY `lessonid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
-- AUTO_INCREMENT for table `sectionlessonbridgetbl`
--
ALTER TABLE `sectionlessonbridgetbl`
  MODIFY `sectionlessonbridgeid` int(10) NOT NULL AUTO_INCREMENT;
--

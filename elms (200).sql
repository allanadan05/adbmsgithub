...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2019 at 08:34 PM
...
(19, 'Welcome!', 'Learn the best course this year!', '2019-11-29', 'Dan Astillero', 5, 0, 0),
...
(22, 'Welcome', 'Take your quizzes now!', '2019-12-12', 'decano rye angelica', 0, 2, 0);
...
(73, 'Lesson 1', 'Posting Journal', './uploads/serverStartup.pdf', '', 5);
...
(7, 'Advanced Database Management Systems', 'Learn how to Normalize tables'),
(8, 'fdd', 'dfg'),
(9, 'qwer', 'qwer');
...
--
ALTER TABLE `announcementtbl`
  MODIFY `announceid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `lessontbl`
  MODIFY `lessonid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `sectionsubjecttbl`
  MODIFY `sectionsubjectid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `sectiontbl`
--
ALTER TABLE `sectiontbl`
  MODIFY `sectionid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `teacherstbl`
  MODIFY `teachersid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `teachersubjecttbl`
--
ALTER TABLE `teachersubjecttbl`
  MODIFY `teachersubjectid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

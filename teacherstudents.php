...
<<<<<<< HEAD
            ...
            xhttp.open("GET", "process3.php?secid=" + secid + "&palatandaan=" + palatandaan, true);
=======
...
<<<<<<< HEAD
            ...
            xhttp.open("GET", "process3.php?tosearch=" + tosearch + "&palatandaan=" + palatandaan, true);
            xhttp.send();
        }
        ...
        function editstudent(id) {
            ...
            xhttp.open("GET", "process3.php?forwardedid=" + forwardedid + "&palatandaan=" + palatandaan, true);
            xhttp.send();
        }
=======
...
<<<<<<< HEAD
                                                    <option value="teacherstudentspdf.php">Pdf</option>
=======
...
<<<<<<< HEAD
                                                            ...
                                                            <a
                                                                href="<?php echo "process3.php?deletestudent=1&id=".$row['userid'] ?>">
...
<<<<<<< HEAD
                                name="addstudentsubmit_teachers">Submit</button> &nbsp
                            <button type="submit" id="savebtn" class="btn btn-warning" style="display: none;"
                                name="editstudentsubmit_teachers">Save</button>
                            <!--button onclick="addstudBtn();" type="button" class="btn btn-danger" data-dismiss="modal">Close</button-->
                            <a class="btn btn-danger" data-dismiss="modal" href="teacherstudents.php">Close</a>
=======
...
<<<<<<< HEAD
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="teachersendnotif_forstudent" class="btn btn-primary" id="sendbtn">Send</button>
=======
                        <hr>
                        <h5>From: </h5>

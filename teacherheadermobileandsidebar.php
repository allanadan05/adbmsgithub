        ...
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                <li class="active has-sub" <?php if ($_SESSION['sidebar'] == "dashboard") {
                    ...
                    <a class="js-arrow" href="teacherindex.php">
                        <i class="fas fa-tachometer-alt"></i>Dashboard<?php $sql = "SELECT count(antitle) as announcebilang FROM announcementtbl WHERE userid='$teacher'";
                ...
                <li <?php if ($_SESSION['sidebar'] == "subjects") {
                    ...
                    <a href="teachersubjects.php">
                        <i class="fas fa-book"></i>Subjects<?php $sql = "SELECT count(teachersid) as announcebilang from teachersubjecttbl where teachersid='".$_SESSION['tearcherid']."'";
                                                                        $executeQuery = mysqli_query($con, $sql);
                                                                        $result = mysqli_fetch_array($executeQuery);
                                                                         $ibalik = $result['announcebilang']; 
                                                                         if($ibalik>0){

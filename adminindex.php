                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mx-auto d-block">
                                            ...
                                            <h5 class="text-sm-center mt-2 mb-1"><?php echo teachersgetname($id);?></h5>
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" placeholder="" required="" value=<?php echo teacherid($id);?> readonly class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail2" class="px-1  form-control-label">FirstName</label><br>
                                                <input type="email" id="email" placeholder="" required="" value=<?php echo teachergetfname($id);?> readonly class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName2" class="pr-1  form-control-label">Lastname</label><br>
                                                <input type="text" id="name" placeholder="" required="" value=<?php echo teachergetlname($id);?> readonly class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail2" class="px-1  form-control-label">Middlename</label><br>
                                                <input type="email" id="email" placeholder="" required="" value=<?php echo teachergetmname($id);?> readonly class="form-control">
                                            </div>

...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2019 at 10:33 AM
...
INSERT INTO `questiontbl` (`questionid`, `question`) VALUES
(1, '1+1?'),
(2, 'sino ang pinaka malakas na hero sa dota?');
...
INSERT INTO `quiztbl` (`quizid`, `quizname`, `subjectid`, `questionid`, `optionsid`, `answerid`, `duration`, `status`) VALUES
(1, 'title', 5, 1, 1, 1, '01:01:00', 'ACTIVATED'),
(2, 'dota oh ako!', 2, 2, 2, 2, '01:01:00', 'ACTIVATED');
...
--
ALTER TABLE `answertbl`
  MODIFY `answerid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `optionstbl`
  MODIFY `optionsid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `questiontbl`
--
ALTER TABLE `questiontbl`
  MODIFY `questionid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--

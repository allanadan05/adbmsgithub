                                            ...
                                            <form action="" method="post" class="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name" placeholder="" required=""
                                                        value=<?php echo teacherid($teachersid);?> readonly
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="email" placeholder="" required=""
                                                        value=<?php echo teachergetfname($teachersid);?> readonly
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName2"
                                                    ...
                                                    <input type="text" id="name" placeholder="" required=""
                                                        value=<?php echo teachergetlname($teachersid);?> readonly
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail2"
                                                    ...
                                                    <input type="email" id="email" placeholder="" required=""
                                                        value=<?php echo teachergetmname($teachersid);?> readonly
                                                        class="form-control">
                                                </div>
                    ...
                    <div class="modal-header">
                        <form action="announcement.php" method="POST">
                            <h5 class="modal-title" id="mediumModalLabel"><input type="text" name="antitle"
                                    placeholder="Type title announcement here..." style="width: 500px"></h5>
                    </div>
                    <div class="modal-body">
                        <textarea rows="5" cols="90" name="andetails"
                            placeholder="Type your message here..."></textarea>
                        <hr />
                        <Label for="anfrom">From: </Label> &nbsp <input type="text" name="anfrom"
                            value="<?php echo teachersgetname($teachersid);?>" style="display:inline; color: grey;"
                            readonly>

                                ...
                                <div class="col-md-4">
                                    <form action="process2.php" method="POST">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <strong class="card-title"><input type="text" name="newsectionname"
                                                        id="addsecname" placeholder="Enter Section name">
                                                    <input type="hidden" name="hiddenname" id="hiddenid">
                                                </strong>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-primary" style="float:right; display: inline;"
                                                    name="addsection" id="addsecbtn" type="submit"><i
                                                        class="fas fa-plus"></i>ADD</button>
                                                <button type="submit" class="btn btn-warning"
                                                    style="float:right; display: none;" name="editsecsubmit"
                                                    id="editsecbtn"><i class="fas fa-save"></i> SAVE</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <form action="process2.php" method="POST">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <strong class="card-title"> <input type="text" name="newdeptname"
                                                        id="adddeptname" placeholder="Enter deaprtment name"
                                                        autofocus="autofocus"> </a>
                                                    <input type="hidden" name="hiddendeptname" id="hiddendeptid">
                                                </strong>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-primary" style="float:right; display: inline;"
                                                    type="submit" name="adddept" id="adddeptbtn"><i
                                                        class="fas fa-plus"></i>ADD</button>
                                                <button type="submit" class="btn btn-warning"
                                                    style="float:right; display: none;" name="editdeptsubmit"
                                                    id="editdeptbtn"><i class="fas fa-save"></i> SAVE</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <table class="table table-top-campaign">
                                                ...
                                                {?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm btn-warning" id="updatesec"
                                                                onclick="editsection(<?php echo $row['sectionid']; ?>)"><i
                                                                    class="fas fa-pencil-square-o"></i>EDIT</button>
                                                        </td>
                                                        <td><a
                                                                href="<?php echo "process2.php?deletesection=1&id=".$row['sectionid'] ?>"><button
                                                                    class="btn btn-sm btn-danger" id="delsec"><i
                                           ...
                                           $sql="SELECT departmenttbl.deptid,departmenttbl.departmentname,count(teacherstbl.teachersid) as 'number of students' from teacherstbl join departmenttbl on teacherstbl.deptid=departmenttbl.deptid group by departmenttbl.departmentname ";
                                            ...
                                            {?>
                                                    <tr>
                                                        ...
                                                        <?php  echo "<td>".$row['number of students']."</td>"; ?>
                                                        <td><button class="btn  btn-sm btn-warning" id="updatedept"
                                                                type="button"
                                                                onclick="editdept(<?php echo $row['deptid']; ?>)"><i
                                                                    class="fas fa-pencil-square-o"></i>EDIT</button>
                                                        </td>
                                                        <td><a
                                                                href="<?php echo "process2.php?deletedept=1&id=".$row['deptid'] ?>"><button
                                                                    class="btn  btn-sm btn-danger" id="deldept"><i
